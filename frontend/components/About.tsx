...
import { BuyButton } from './design/BuyButton';
import { Title } from './design/Title';

export function About()
{
    return <div className="container w-11/12 lg:w-6/12 mx-auto m-6 p-3 rounded border border-secondary">
        <Title>The NoTrack project</Title>
        The No-Track project is a set of tools that can be used :
        <ul className="list-disc list-inside pt-2 pb-2">
            <li>For free</li>
        ...
        <a href="https://github.com/prism-be/Prism.NoTrack.Shortener">Prism.NoTrack.Shortener</a>.

        <SubTitle>Bugs ? Support ?</SubTitle>
        This project is made on personal time, with the use of NextJs. there can be bugs, I can take time to fix them.
        <br/>
